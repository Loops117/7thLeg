...
(function(){
  ...
  function createBanner(){
    ...
    bar.id = NUDGE_ID;
    // Width is 100% of the target container; sticky within that column
    bar.style.cssText = [
      'position:sticky',
      'top:0',
      'z-index:100',
    ...
    bar.innerHTML = `
      <div style="flex:1 1 auto">
        ...
        <div style="font-size:.9rem;color:#475569">We’re asking members to tell us about species they keep. Do you mind answering a few questions for contribution points?</div>
      </div>
      <div style="display:flex;gap:.5rem">
        ...
        <button type="button" id="qna-close" aria-label="Close" style="border:none;background:transparent;font-size:18px;line-height:1">✕</button>
      </div>
    `;
    return bar;
  }
